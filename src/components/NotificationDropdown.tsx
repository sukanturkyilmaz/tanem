...
import { Bell, X, Check, MessageSquare, Calendar, AlertCircle, Megaphone } from 'lucide-react';

interface Notification {
  id: string;
  title: string;
  message: string;
  type: 'new_message' | 'policy_renewal' | 'new_claim' | 'announcement' | 'message_reply';
  link: string | null;
  read: boolean;
  created_at: string;
